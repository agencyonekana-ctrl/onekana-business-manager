...
const steps: TourStep[] = [
  {
    ...
    description: 'Commencez par les indicateurs de supervision: contacts, demandes, campagnes, finances et disponibilites.',
  },
  {
    id: 'contacts',
    route: '/contacts',
    target: 'contacts-table',
    title: 'Consulter les contacts',
    description: 'Retrouvez les contacts enregistres, leurs entreprises, leurs coordonnees et leur etat de suivi.',
  },
  {
    id: 'lead',
    route: '/demandes',
    target: 'client-requests-table',
    title: 'Qualifier une demande client',
    description: 'Les demandes entrantes sont indexees ici pour suivre leur etape et la prochaine action.',
  },
  {
    id: 'campaign',
    route: '/campaigns',
    target: 'campaigns-workspace',
    title: 'Controler les campagnes recues',
    description: 'Consultez les campagnes transmises et verifiez leur statut, leur periode et les disponibilites.',
  },
  {
    id: 'inventory',
    route: '/inventory',
